...
namespace model_straussR_fixed_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_straussR_fixed");
    ...
    reader.add_event(153, 2, "restart", "model_straussR_fixed");
    ...
    reader.add_event(317, 3, "restart", "model_straussR_fixed");
    ...
    reader.add_event(393, 4, "restart", "model_straussR_fixed");
    ...
    reader.add_event(496, 5, "restart", "model_straussR_fixed");
    ...
    reader.add_event(660, 6, "restart", "model_straussR_fixed");
    reader.add_event(744, 90, "end", "model_straussR_fixed");
    return reader;
}
...
#include <meta_header.hpp>
 class model_straussR_fixed : public prob_grad {
private:
    int MAX_PAR;
    int N_unbounded;
    int N_positive;
...
public:
    model_straussR_fixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_straussR_fixed_namespace::model_straussR_fixed";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(distributions_lpdf<propto__>(Z, N, stan::model::rvalue(params, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list())), "params"), SQRT_M, lower_bounds, upper_bounds, dist_indices, p, pstream__));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_straussR_fixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_straussR_fixed_namespace::model_straussR_fixed stan_model;
